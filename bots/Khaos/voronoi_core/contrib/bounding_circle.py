...
from voronoi_core import Polygon
from voronoi_core.algorithm import Algorithm
from voronoi_core.graph import Point, Coordinate, Vertex

DEBUG = False

if DEBUG:
    from voronoi_core.visualization import Visualizer
