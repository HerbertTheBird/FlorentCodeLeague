...
Left as-is. The weights are deliberately sub-floor, not an oversight for someone
to "fix" later -- and the v54 reversion strengthens that. We already build far
more turrets than the teams above us (26 gunners to sporks' 10 in one
instrumented game), and every change that makes ADDITIONAL turret placements
legal has lost. The one that paid, MIN_ATTACK_SCORE, made fewer of them legal.
