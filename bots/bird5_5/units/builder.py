...
import units.states.rush_attack as rush_attack
...
states = tuple(sorted(
    [explore, disrupt, harvest, route, heal, attack, chase, chip, block, rush_attack],
...
def run():
    ...
    # Being pulled into a fight (heal/attack) is a PAUSE of the opening conveyor
    # plan, not a cancel. Was: conveyor_plan = None -- permanent, so one enemy
    # sighting ended the build order for the rest of the game and stranded whatever
