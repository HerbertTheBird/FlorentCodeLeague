...
# 4.5 -> 3.5: below harvest (4), above disrupt (2). The module docstring claimed a
# raider was "worth interrupting a harvest run to defend the economy". Half of that
# is right and half is not. Removing chase entirely costs -0.2811 over 86 games --
# it is the largest regression measured -- because standing next to a raider lets
# the free per-turn heal out-repair what it chips. But letting it outrank harvest
# costs 0.0854: chase is available on 37% of builder-turns and wins every contest
# it enters, while harvest is available on only 1.9%, so the rare turn where both
# apply is exactly the turn the economy cannot afford to skip.
MAX_SCORE = 3.5
_cached_target = None
