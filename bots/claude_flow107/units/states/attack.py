...
# #41 FLOW TARGETING. Conveyors were zeroed for BOTH turret types, so turrets pour
# damage into a 500 HP core they can never finish and never touch the belt feeding
# it (measured: 28% of all shots at the core). map_info._bm_ti_carrying already says
# which conveyors are believed loaded -- and v107 widened that belief to
# harvester-fed belts -- so a loaded 20 HP belt tile is the thing worth shooting.
