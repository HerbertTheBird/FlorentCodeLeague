...
MAX_SCORE = 9.8        # ABOVE ringcut(9.7). At 7.2 it chose a corner 32 times in
                     # ~12000 calls and BUILT ZERO gunners -- it never won a turn,
                     # so the idea was never actually tested.
