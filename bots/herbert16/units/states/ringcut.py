...
LAUNCH_GUARD = True      # cs_lg measured +0.2441 vs cs_all's +0.2220: when every ring
                         # conveyor is guarded, place a launcher beside one so
                         # turret_launcher._try_throw_enemy_away() removes the healer     # build a launcher to throw a guard away
SIEGE_ID_MAX = 4
