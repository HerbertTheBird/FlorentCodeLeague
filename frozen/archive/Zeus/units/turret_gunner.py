...
# Rotation only chases the core or an enemy turret (never harvesters/conveyors).
# Higher is better: the core beats any turret, and among turrets the order is
# gunner > launcher > sentinel.
...
def _choose_rotate_dir():
    """Best facing to rotate toward whose line yields a core or enemy-turret
    shot. Ranks core over any turret, gunner > launcher > sentinel within
    turrets, then nearer target, then stable direction order."""
