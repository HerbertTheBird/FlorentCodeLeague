...
def ensure_launcher_or_wait(rc) -> bool:
    ...
    global _launch_wait
    # Once the opening transport phase is complete, never use this generic wait
    # gate again. Economy defenders later return to the surviving launcher, but
    # their dedicated park/mirror states decide when to hold or be dispatched.
