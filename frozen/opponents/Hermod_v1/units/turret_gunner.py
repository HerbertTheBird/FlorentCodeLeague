...
# Rotation chases only the core or enemy turrets. Enemy builders remain valid
# shots in the gunner's CURRENT facing, but never justify spending a turn and
# titanium rotating toward them.
...
def _choose_rotate_dir():
    """Best facing yielding a core or enemy-turret shot.

    Ranks core first, then gunner > launcher > sentinel; nearer targets and
    stable direction order break ties. Builder-only lines are ignored.
    """
